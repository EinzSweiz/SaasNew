...
def get_checkout_customer_plan(session_id):
    checkout_r = get_checkout_session(stripe_id=session_id, raw=True)
    customer_id = checkout_r.customer
    sub_stripe_id = checkout_r.subscription
    sub_r = get_subscription(stripe_id=sub_stripe_id, raw=True)
    sub_plan_id = sub_r['plan']['id']
    return  customer_id, sub_plan_id